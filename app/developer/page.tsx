...
export default function DeveloperHub() {
  const devTools = toolsRegistry.filter(t => t.category === "developer");
  
  // Group tools by subcategory
  const toolsBySubCategory = devTools.reduce((acc, tool) => {
  ...
  return (
    <div className="container mx-auto px-4 py-12 sm:px-6 lg:px-8">
      <div className="mb-16 text-center">
        ...
        <h1 className="text-4xl font-extrabold tracking-tight mb-4">Developer Hub</h1>
        <p className="text-xl text-muted-foreground max-w-2xl mx-auto">
          Essential utilities for developers: formatters, converters, encoders, and generators.
        </p>
      </div>
