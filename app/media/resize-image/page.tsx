  ...
  return (
    <ToolLayout
      ...
      faqContent={[
        ...
        { question: "What are the best dimensions for social media?", answer: "Instagram: 1080x1080 (square), Twitter: 1200x675 (16:9 card), Facebook: 1200x630 (1.91:1 link share), LinkedIn: 1200x627 (1.91:1)." },
        { question: "Will resizing reduce image quality?", answer: "Resizing to smaller dimensions reduces quality since pixels are removed. Enlarging (upscaling) can cause blurriness since new pixels must be interpolated. For best results, start with a high-resolution source." },
        ...
        { question: "What file formats are supported?", answer: "We support JPEG, PNG, and WebP input formats. The output is JPEG by default with 92% quality." },
      ]}
      explanationContent={
        <div className="space-y-6">
          ...
          <section>
            ...
            <ol className="list-decimal list-inside space-y-2 text-muted-foreground">
              ...
              <li>Optionally select a preset size from the dropdown</li>
              <li>Click &ldquo;Resize Image&rdquo; to process and download</li>
            </ol>
          </section>
          <section>
            ...
            <ul className="list-disc list-inside space-y-2 text-muted-foreground">
              ...
              <li>High-quality bilinear interpolation</li>
